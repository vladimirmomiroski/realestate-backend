-- commercial-office-first-page-02-page-root
...
LEFT JOIN "ListingLandDetails" AS l3 ON s."Id" = l3."ListingId"
ORDER BY s."Price", s."CreatedAtUtc" DESC, s."Id" DESC
