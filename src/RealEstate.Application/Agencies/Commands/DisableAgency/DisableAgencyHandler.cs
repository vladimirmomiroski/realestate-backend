...
namespace RealEstate.Application.Agencies.Commands.DisableAgency;

public sealed class DisableAgencyHandler
{
    private readonly PlatformAdminAccessChecker _platformAdminAccessChecker;
    private readonly IAgencyRepository _agencyRepository;

    public DisableAgencyHandler(
        ...
        ServiceResult<AgencyResponse>? accessFailure =
            await _platformAdminAccessChecker
                .EnsureCurrentUserIsActiveAdminAsync<AgencyResponse>(
                    "Only active platform administrators can disable agencies.",
                    cancellationToken);
